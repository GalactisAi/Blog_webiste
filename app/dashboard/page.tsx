            ...
            <div className="flex">
              ...
              <div className="ml-3">
                <h3 className="text-sm font-medium text-yellow-800">
                  ⚠️ Posts Not Persisting - Database Not Configured
                </h3>
                <div className="mt-2 text-sm text-yellow-700">
                  <p>
                    Your posts are stored in temporary memory and will be lost on server restart or deployment.
                    To persist posts permanently, set up Supabase database.
                  </p>
                  <p className="mt-2 font-semibold">Quick Setup:</p>
                  <ol className="mt-1 list-decimal list-inside space-y-1">
                    <li>Create a free Supabase project at <a href="https://supabase.com" target="_blank" rel="noopener" className="underline">supabase.com</a></li>
                    <li>Run the SQL from <code className="bg-yellow-100 px-1 rounded">database/schema.sql</code> in Supabase SQL Editor</li>
                    <li>Add environment variables in Vercel: <code className="bg-yellow-100 px-1 rounded">NEXT_PUBLIC_SUPABASE_URL</code> and <code className="bg-yellow-100 px-1 rounded">NEXT_PUBLIC_SUPABASE_ANON_KEY</code></li>
                    <li>See <code className="bg-yellow-100 px-1 rounded">DATABASE_SETUP.md</code> for detailed instructions</li>
                  </ol>
                </div>
              </div>
            </div>
